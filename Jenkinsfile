node {
    ...
    stage('Deploy Docker Image and login'){
      ...
      echo "Docker Image Tag Name: ${dockerImageTag}"
        ...
        sh "docker images"
        sh "docker login -u arunzdevcloud -p arunzdevcloud@13" // put PWD
	...
	//sh "read imageid"
	   sh "docker tag b844b88441f2   arunzdevcloud/myapplication" //must change your name and tag no
        sh "docker push   arunzdevcloud/myapplication"
  }
}
